...
@Component
public class ReentrantReadWriteLockStrategyWithNoTransaction implements LockStrategy {
	private final LockMetrics metrics;
	private final AccountRepository accountRepository;
	private final ConcurrentHashMap<Long, ReentrantReadWriteLock> locks = new ConcurrentHashMap<>();

	public ReentrantReadWriteLockStrategyWithNoTransaction(LockMetrics metrics, AccountRepository accountRepository) {
	...
	public Strategy getStrategyType() {
		return REENTRANT_READ_WRITE_LOCK_WITH_NO_TX;
	}
