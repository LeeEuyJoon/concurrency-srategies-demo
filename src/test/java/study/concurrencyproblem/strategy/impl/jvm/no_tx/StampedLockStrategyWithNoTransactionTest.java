...
@SpringBootTest
@Testcontainers
class StampedLockStrategyWithNoTransactionTest {
	@Container
	...
	@Autowired
	private StampedLockStrategyWithNoTransaction strategy;
	@Autowired
	...
	@Test
	@DisplayName("Stamped No Tx - 잔고가 100,000원인 계좌에서 두 스레드가 동시에 50,000원을 인출")
	...
	@Test
	@DisplayName("Stamped No Tx - 잔고가 100,000원인 계좌에서 50개의 스레드가 동시에 1,00원씩 인출")
